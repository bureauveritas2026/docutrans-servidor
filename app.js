...
function handleFile(file) {
    ...
    if (!['txt', 'docx', 'pptx'].includes(ext)) {
        alert('Formato no soportado. Por favor sube un archivo TXT, DOCX o PPTX.');
        return;
    }
    ...
    icon.className = 'file-icon fa-solid ' + 
        (ext === 'docx' ? 'fa-file-word' : 
         ext === 'pptx' ? 'fa-file-powerpoint' : 'fa-file-lines');
